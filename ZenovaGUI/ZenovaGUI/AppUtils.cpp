...
void AppUtils::StateChangeMonitor::initialize(const wchar_t* packageFullName, IPackageDebugSettings* packageDebugSettingsIn) {
	this->registrationId = 0;
	this->packageDebugSettings = packageDebugSettingsIn;
	HRESULT lol = this->packageDebugSettings->RegisterForPackageStateChanges(packageFullName, this, &this->registrationId);
}
